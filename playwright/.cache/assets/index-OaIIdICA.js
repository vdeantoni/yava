...
function useStore(api, selector = identity) {
  const slice = __pwReact.useSyncExternalStore(
    api.subscribe,
    __pwReact.useCallback(() => selector(api.getState()), [api, selector]),
    __pwReact.useCallback(() => selector(api.getInitialState()), [api, selector])
  );
  __pwReact.useDebugValue(slice);
  return slice;
}
...
const _Users_vdeantoni_workspace_vdeantoni_yava_tests_components___components_panels_TrimPanel = () => __vitePreload(() => import('./TrimPanel-BZCb4450.js'),true              ?[]:void 0).then((mod) => mod.default);
__pwRegistry.initialize({ _Users_vdeantoni_workspace_vdeantoni_yava_tests_components___components_panels_TrimPanel });

export { React as R, getDefaultExportFromCjs as g, reactExports as r, useAppStore as u };
//# sourceMappingURL=index-OaIIdICA.js.map
